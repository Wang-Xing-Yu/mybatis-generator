 ...
 * @Author: Eric
 */
public abstract class CustomAbstractSelectAllMethodGenerator extends AbstractJavaMapperMethodGenerator {
    private boolean isSimple;

    CustomAbstractSelectAllMethodGenerator(boolean isSimple) {
        super();
